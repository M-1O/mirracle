...
// required double ozone,
  ...
  @override
  String toString() {
    return 'Weather(date: $date, temperature: $temperature, condition: $condition, windSpeed: $windSpeed, humidity: $humidity, pressure: $pressure, visibility: $visibility, cloudCover: $cloudCover, maxTemperature: $maxTemperature, minTemperature: $minTemperature, feelsLike: $feelsLike, location: $location, cityName: $cityName)';
  }
...
abstract class _Weather implements Weather {
  const factory _Weather(
      ...
      final String? cityName}) = _$_Weather;
